    ...
    <div class="container mt-5" style="height: auto;">
        <div class="row align-items-center mt-2">
            <div class="col-md-9 ml-auto mr-auto mt-5 text-center">
                <h3>{{ __('Quniela Mundial Qatar 2022. Modulo de Registro de Jugadores') }} </h3>
            </div>
                ...
                <form class="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="card card-login card-hidden mx-auto">
                        <div class="card-header card-header-primary text-center">
                            <h4 class="card-title"><strong>{{ __('Registrarse como Jugador') }}</strong></h4>
                            ...
                            <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        placeholder="{{ __('Nombres...') }}" value="{{ old('name') }}" required>
                                </div>
                                @if ($errors->has('name'))
                ...
                {{ __('I agree with the ') }} <a href="#">{{ __('Privacy Policy') }}</a>
                        ...
                        <div class="card-footer mx-auto">
                            <button type="submit" class="btn btn-info  btn-lg"
                                style="color: white">{{ __('Registrarse') }}</button>
                        </div>
                    </div>
                </form>
            </div>
