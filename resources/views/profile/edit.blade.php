@extends('layouts.app', ['activePage' => 'profile', 'titlePage' => __('Cuenta de usuario')])
                    ...
                    <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Editando Perfil') }}</h4>
                                <p class="card-category">{{ __('Datos del Usuario') }}</p>
                            </div>
                            <div class="card-body ">
                                @if (session('status'))
                                    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Cambiando Password') }}</h4>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <label class="col-sm-2 col-form-label"
                                        for="input-password-confirmation">{{ __('Confirme el Nuevo Password') }}</label>
                                    <div class="col-sm-7">
